...
const pairs: Record<Theme, Theme> = {
  'pink-light': 'pink-dark', 'pink-dark': 'pink-light',
  'purple-light': 'purple-dark', 'purple-dark': 'purple-light',
}
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ThemeContext.Provider value={{ theme, setTheme, toggleDark, isDark: theme.endsWith('-dark') }}>
      {children}
